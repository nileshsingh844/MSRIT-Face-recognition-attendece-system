...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Label(ec, text='Please enter your subject name!!!', fg='black',
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            ENR = tk.Label(MFW, text="Enter USN", width=15, height=2, fg="black", bg="grey",
                           font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'C:/Face-Recognitio/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Face-Recognitio\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Face-Recognitio/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Face-Recognitio\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    sub = tk.Label(windo, text="Enter Subject : ", width=15, height=2,
                   fg="white", bg="#800000", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)
...
def admin_panel():
    ...
    win.configure(background='#800000')
    ...
    def log_in():
        ...
        if username == 'pavan':
            if password == 'pavan123':
                ...
                cs = 'C:/Face-Recognitio/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="MSRIT-Face-Recognition-Based-Attendance-Management-System", bg="#191970", fg="white", width=50,
...
lbl = tk.Label(window, text="Enter USN : ", width=20, height=2,
               fg="white", bg="#800000", font=('times', 15, 'bold'))
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="white",
                bg="#800000", height=2, font=('times', 15, ' bold '))
